...
if __name__ == "__main__":
    image_path = r"<PROJECT_ROOT>\figure-res-1\washOut\MalignantP005_NOR.nii"  # 原始 MRI
    mask_path = r"<DCM_ROOT>\malignant-DCE-451subs\part1-288subs+part2\P005_NOR\8.nii"    # 对应 mask
    out_root = "./res_pic"
...
# if __name__ == "__main__":
#     # 1）修改成你自己的文件路径
#     image_path = r"<PROJECT_ROOT>\figure-res-1\washIn\MalignantP005_NOR.nii"  # 原始 MRI
#     mask_path = r"<DCM_ROOT>\malignant-DCE-451subs\part1-288subs+part2\P005_NOR\8.nii"    # 对应 mask
