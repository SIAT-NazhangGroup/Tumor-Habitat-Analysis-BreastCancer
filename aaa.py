...
# peak_path = r"E:\liuzhou_breastcancer\Malignant_nii\P005_NOR\3\3.nii"
# peak_data = nib.load(peak_path).get_fdata()

pic_save = r'E:\ckx\ISMRM'
# label_path = r'E:\DCESummary_2019-202004\malignant-DCE-451subs\part1-288subs+part2\100\Untitled.nii.gz'
label_path = r'E:\DCESummary_2019-202004\benign-DCE-221subs\part1-175subs+part2\12\Untitled.nii.gz'
label = nib.load(label_path).get_fdata()
file_path = (r"E:\liuzhou_breastcancer\figure-res-0\washOut\Benign12.nii")
...
background = cv2.imread(r'E:\liuzhou_breastcancer\res_pic\result_fig\Benign12\third.png')
