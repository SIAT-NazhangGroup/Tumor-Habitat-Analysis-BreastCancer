...
# 标签地址
label_csv = r'E:\liuzhou_breastcanver\datas_patho.csv' #原本这个文件是E:\liuzhou\data_path.csv

# 结果保存地址
pic_save = r'E:\liuzhou\res_pic\result_fig1'

file_path = r'E:\liuzhou_breastcancer\figure-res-1\washIn\Malignant1.nii'
label_path = r'E:\DCESummary_2019-202004\malignant-DCE-451subs\part1-288subs+part2\1\Untitled.nii.gz'
...
# background = cv2.imread(r'E:\liuzhou\res_pic\result_fig1\Benignsz_38440\data.png')
